...
cfg.arch.max_epochs = 100                # Maximum number of epochs
########################################################################################################################
### CHECKPOINT
########################################################################################################################
cfg.checkpoint = CN()
...
cfg.model.optimizer.pose.lr = 0.0005            # Pose learning rate
...
cfg.model.scheduler.step_size = 40      # Scheduler step size
...
cfg.datasets.augmentation.image_shape = (384, 640)              # Image shape
